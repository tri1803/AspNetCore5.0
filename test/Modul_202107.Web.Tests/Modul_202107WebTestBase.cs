...
{
    public abstract class Modul_202107WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Modul_202107WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Modul_202107WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Modul_202107DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Modul_202107DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Modul_202107DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Modul_202107DbContext, Task<T>> func)
        {
            T result;
